...
public class JCheckBoxDemo extends JPanel {
	...
	public JCheckBoxDemo() {
		...
		jlbPicture = new JLabel(new ImageIcon(getClass().getResource("/images/geek-" + choices.toString().trim() + ".gif")));
	...
	class CheckBoxListener implements ItemListener {
		public void itemStateChanged(ItemEvent e) {
			...
			jlbPicture.setIcon(new ImageIcon(getClass().getResource("/images/geek-" + choices.toString().trim() + ".gif")));
